...
export default function Onboarding() {
  ...
  const [formData, setFormData] = useState({
    ...
    defaultTaxRate: '15',
    defaultMarkup: '20',
    terms: 'Payment is due within 14 days of invoice date. All materials remain property of the contractor until paid in full.',
    defaultCurrency: 'ZAR',
    country: 'ZA',
    vatNumber: '',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-4 py-12">
      <Card className="w-full max-w-xl">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Welcome to SoloBid</CardTitle>
          <CardDescription>
            Let's set up your business profile so you can start sending quotes and invoices.
          </CardDescription>
        </CardHeader>
        <CardContent>
